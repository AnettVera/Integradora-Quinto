...
const UpdateStudents = ({ isUpdate, setUpdate, getAllStudents, id }) => {
  const closeModal = () => {
    setUpdate(false);
  }
    ...
    const fetchStudentData = async () => {
      try {
        ...
        if (response.data) {
          ...
          formik.setFieldValue('secondNameU', response.data.person.secondName ?? '')
  ...
  return (
    <div>
      <Modal show={isUpdate} size="md" onClose={closeModal} popup>
        ...
        <Modal.Header />
        <h3 className="text-xl font-medium text-blue-600 dark:text-white text-center">Actualizar estudiante</h3>
        <Modal.Body>
          <div className="space-y-3">
            ...
            >
              ...
              <div>
                <div className="mb-0.5 block">
                  <Label htmlFor="usernameU" value="Matricula" className="font-bold" />
                </div>
                <TextInput
                  type="text"
                  id="usernameU"
