...
import { pconfirmAlert } from '../../config/alerts/alert';
...
const SettingsStudents = () => {
  ...
  const getUsers = async () => {
    try {
      const response = await AxiosClient({ url: "/user/allStudents", method: 'GET' });
  ...
  return (
    <>
      <div className='w-full h-10 bg-blue-100 flex justify-between items-center p-4'>
        ...
        <Tooltip content='Agregar estudiante'>
      ...
      <div className='justify-center p-3'>
        ...
        <RegisterUserS isCreating={isCreating} setIsCreating={setIsCreating} getAllStudents={getUsers} />
        <UpdateStudents isUpdate={isUpdate} setUpdate={setUpdate} getAllStudents={getUsers} id={userId} />
      </div>
    </>
  )
}
